...
//
// func (stubSubSvc) Subscribe(info *subscriptions.Info) error   { return nil }
// func (stubSubSvc) Unsubscribe(info *subscriptions.Info) error { return nil }
// func (stubSubSvc) Confirm(info *subscriptions.Info) error     { return nil }
//
// type stubNotifSvc struct{}
//
//func (stubNotifSvc) SendMessage(string, string, string, string) error { return nil }
//
