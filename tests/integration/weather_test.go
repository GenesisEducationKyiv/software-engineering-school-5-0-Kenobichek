...
func (stubSubSvc) Subscribe(*repository.Subscription) error   { return nil }
func (stubSubSvc) Unsubscribe(*repository.Subscription) error { return nil }
func (stubSubSvc) Confirm(*repository.Subscription) error     { return nil }
